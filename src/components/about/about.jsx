                    ...
                    <div class="team-box">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src={require('../../images/staff-01.jpg')} alt=""/></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>John Doggett</h3>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src={require('../../images/staff-02.jpg')} alt=""/></a>
                                    </div>
                                    <div class="text-col">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src={require('../../images/staff-03.jpg')} alt=""/></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Monica Reyes</h3>
                                        <p>Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Aenean commodo ligula.</p>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#1">
                                    <img src={require('../../images/gallery_01.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#2">
                                    <img src={require('../../images/gallery_02.jpg')} alt=""/>
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#3">
                                    <img src={require('../../images/gallery_03.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#4">
                                    <img src={require('../../images/gallery_04.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#5">
                                    <img src={require('../../images/gallery_05.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#9">
                                    <img src={require('../../images/gallery_06.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#10">
                                    <img src={require('../../images/gallery_07.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#11">
                                    <img src={require('../../images/gallery_08.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#12">
                                    <img src={require('../../images/gallery_09.jpg')} alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#13">
                                    <img src={require('../../images/gallery_10.jpg')} alt="" />
                                </a>
